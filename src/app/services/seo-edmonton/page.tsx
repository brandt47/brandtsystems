...
export const metadata: Metadata = {
  title: "SEO Services Edmonton | Local SEO & Google Rankings",
  description:
    "Get found on Google by Edmonton customers already searching for your services. SEO audits, local SEO, Google Business Profile optimization, and on-page SEO for Alberta businesses.",
  keywords: [
    "SEO Edmonton",
    "local SEO Edmonton",
    "SEO services Edmonton Alberta",
    "Google Business Profile optimization Edmonton",
    "SEO audit Edmonton",
    "search engine optimization Edmonton",
    "local SEO Alberta",
    "Edmonton SEO consultant",
    "small business SEO Edmonton",
  ],
  openGraph: {
    title: "SEO Services Edmonton | Brandt Systems",
    description:
      "Get found on Google by Edmonton customers already searching for your services. Local SEO, audits, and Google Business Profile optimization.",
    url: "https://brandtsystems.ca/services/seo-edmonton",
  },
};

const content = seoLandingPage;

export default function SEOLandingPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "ProfessionalService",
    name: "SEO Services — Brandt Systems",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            "@type": "Service",
            name: "SEO Audit & Quick Wins Report",
            description:
              "Complete Google Business Profile audit, on-page SEO review, local citation check, competitor gap analysis, and prioritized action list.",
          },
          priceSpecification: {
    ...
    <>
      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 min-h-[450px] lg:min-h-[50vh] flex items-center">
        <Image
          ...
          alt="SEO services for Edmonton businesses"
          fill
          priority
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-8">
            Is your Edmonton business invisible on Google?
          </h2>
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            ...
            >
              ...
              <p className="text-sm text-gray-500">
                Pair your SEO strategy with paid ads for faster results and more
                leads.
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="text-sm text-gray-500">
                Convert your SEO traffic into booked appointments and quote
                requests.
              </p>
            </Link>
          </div>
