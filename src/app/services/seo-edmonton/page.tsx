...
import { siteConfig, seoLandingPage } from "@/content/siteContent";

export const metadata: Metadata = {
  title: "SEO Services Edmonton | Local SEO in 60 Days | Brandt Systems",
  description:
    ...
    <>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-3xl mx-auto">
          ...
          <FAQAccordion items={seoLandingPage.faq} />
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50 border-t border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            <Link
              href="/services/edmonton-visibility-sprint"
            ...
            >
              ...
              <p className="text-sm text-gray-500">
                See the full sprint breakdown with week-by-week timeline and
                deliverables.
              </p>
            </Link>
            <Link
